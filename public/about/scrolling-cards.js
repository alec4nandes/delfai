const headerElem = document.querySelector("header"),
    scrollCardsElems = [...headerElem.querySelectorAll(".scroll-cards")],
    cardNames = ["Fool", "High Priestess", "Wheel of Fortune", "Star", "World"],
    getCardImgs = (isReversed) =>
        (isReversed ? [...cardNames].reverse() : cardNames)
            .map((cardName) => `<img src="/assets/cards/${cardName}.jpg"/>`)
            .join(""),
